...
public class ULN2003Tests {
	...
	//
	// static TestingDigitalOutputDeviceFactory factory = new
	// TestingDigitalOutputDeviceFactory();
	//
	// @BeforeAll
	...
	// ULN2003 motor = new ULN2003(Mode.FULL_STEP, ULN2003.STEPPER_28BYJ48, 1, 2, 3,
	// 4);
	...
	// ULN2003 motor = new ULN2003(Mode.FULL_STEP, ULN2003.STEPPER_28BYJ48, 17, 27,
	// 22, 23);
