...
public class TB6612FNG {
    ...
    /*
     * private void setAddr(int newAddress) { if (newAddress == 0x00 || newAddress
     * >= 0x80) { return; } new I2CDevice()
     *
     *
     *
     *
     * I2Cdev::writeByte(_addr, GROVE_MOTOR_DRIVER_I2C_CMD_SET_ADDR, addr); _addr =
     * addr; delay(100); }
     *
     * }
     */
    ...
    public class Stepper {
         ...
         *
         * @param mode
         *            4 driver mode: FULL_STEP,WAVE_DRIVE, HALF_STEP, MICRO_STEPPING,
         *            for more information:
         *            https://en.wikipedia.org/wiki/Stepper_motor#/media/File:Drive.png
         * @param steps:
         *            The number of steps to run, range from -32768 to 32767. When steps
         *            = 0, the stepper stops. When steps > 0, the stepper runs
         *            clockwise. When steps < 0, the stepper runs anticlockwise.
         * @param rpm:
         *            Revolutions per minute, the speed of a stepper, range from 1 to
         *            300. Note that high rpm will lead to step lose, so rpm should not
         *            be larger than 150.
         */
    ...
    public class DC {
         ...
         *
         * @param channel
         *            identifies which motor to drive. (either 1 or 0)
         */
         ...
         *
         * @param speed:
         *            Speed from -255 to 255 to run this motor. (8bit voltage). Note
         *            that there is always a starting speed(a starting voltage) for
         *            motor. If the input voltage is 5V, the starting speed should
