...
public class RobutTest {
    ...
    private static Robut build(RobutContext ctxt, Coordinate origin) throws InterruptedException {

        FakeMover mover = new FakeMover(ctxt, origin);
        FakeBumpSensor bumpSensor = new FakeBumpSensor(ctxt);
        ...
        // mapViz = new MapViz(100, robut.visualizationInitializer());
