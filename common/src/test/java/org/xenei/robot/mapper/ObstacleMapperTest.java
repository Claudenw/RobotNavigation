...
// public void doMapTest(Position currentPosition, Location relativeLocation,
// Coordinate expecObst,
// Coordinate expCoord) {
// MapImpl map = new MapImpl(new RobutContext(ScaleInfo.DEFAULT,
// TestChassisInfo.DEFAULT));
// MapperImpl mapper = new MapperImpl(map);
// Obstacle expected =
// MockObstacleFactory.from(map.getContext().graphGeomFactory.asWKT(expecObst));
//
...
//
// args.add(Arguments.of(Position.from(-1, -3, AngleUtils.RADIANS_90),
// Location.from(.5, 3),
