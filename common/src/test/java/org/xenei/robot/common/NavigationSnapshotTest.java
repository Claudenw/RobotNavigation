...
public class NavigationSnapshotTest {
	...
	static final NavigationSnapshot diffHead = new NavigationSnapshot(Position.from(1, 1, AngleUtils.RADIANS_90),
			target);
	static final NavigationSnapshot diffLoc = new NavigationSnapshot(Position.from(1, 2, AngleUtils.RADIANS_45),
			target);
