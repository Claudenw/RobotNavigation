...
// Supplier<Position> positionSupplier = new
// TestingPositionSupplier(Position.from(-1, -3) );
// Solution solution = new Solution();
// solution.add(positionSupplier.get());
// Map map = new MapImpl(new RobutContext(ScaleInfo.DEFAULT,
// TestChassisInfo.DEFAULT));
// underTest = new FakeDistanceSensor1(MapLibrary.map2(map), positionSupplier);
// MapViz mapViz = new MapViz(1, underTest.map(), () -> solution,
// positionSupplier, () -> null);
// map.getContext().scheduleAtFixedRate(mapViz::redraw, 0,500,
// TimeUnit.MILLISECONDS);
// MapDistanceSensorAdapter adapter = new MapDistanceSensorAdapter(map,
// positionSupplier);
// underTest.addListener(adapter);
// underTest.run();
//
// DebugViz debugViz = new DebugViz(1, map, () -> solution, positionSupplier, ()
// -> null);
// debugViz.redraw();
// Thread.sleep(1000);
