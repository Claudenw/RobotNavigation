...
/**
 * starts with accept sensor layer.
 *  select a corrective action.
 *      ignore sensor layer wile taking corrective action.
 *      move enough to untrigger event.
 *      check sensor layer
 *      if pause go to select a corrective action
 *      if run:
 *          set stop
 *      if stop:
 *          reset trigger?
