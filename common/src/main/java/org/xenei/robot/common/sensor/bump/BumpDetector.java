...
public class BumpDetector implements RobutContext.Processor<SensorLayer> {
    ...
    /**
     * constructor. Automatically registers with the bump topic. Should call
     * {@link #unregister()}
     *
     * @param ctxt
     *            Robut context
    ...
    /**
     * Constructor with existing trigger state. Automatically registers with the
     * bump topic. Should call {@link #unregister()}
     *
     * @param ctxt
     *            Robut context
     * @param lastTrigger
     *            the existing trigger value.
     */
