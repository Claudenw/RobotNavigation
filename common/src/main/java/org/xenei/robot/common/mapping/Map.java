...
public interface Map {
	...
	MapCoordinate asMapCoordinate(FrontsCoordinate coord);
	 ...
	 * @return
	 */
	CompletableFuture<? extends MapCoordinate> setVisited(FrontsCoordinate coord);
	 ...
	 */
	interface MapCoordinate extends FrontsCoordinate {
	};
