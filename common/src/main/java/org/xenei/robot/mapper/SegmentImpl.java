...
public class SegmentImpl implements Segment {
    ...
    public static class Builder {
        ...
        public Segment build(RobutContext ctxt) {
            ...
            return new SegmentImpl(coord, cost, distance, geom);
        }
    }
    ...
    private SegmentImpl(UnmodifiableCoordinate coord, double cost, double distance, Geometry geom) {
        this.coord = coord;
        this.cost = cost;
        this.geom = geom;
        this.distance = distance;
    ...
    @Override
    public String toString() {
        return String.format("Segment {%s cost:%.4f}", CoordUtils.toString(this, 3), cost);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SegmentImpl) {
            return compareTo((SegmentImpl) obj) == 0;
        }
        return false;
    }
