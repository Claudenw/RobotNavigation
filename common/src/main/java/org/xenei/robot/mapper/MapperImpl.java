...
public class MapperImpl implements Mapper {
    ...
    @Override
    public boolean isClearPath(PositionI<?, ?> currentPosition, FrontsCoordinate target) {
    ...
    class ObstacleMapper implements Runnable {
        final Map<?, ?, ?> map;
        final PositionI<?, ?> currentPosition;
        final Location relativeObstacle;

        ObstacleMapper(Map<?, ?, ?> map, PositionI<?, ?> currentPosition, Location relativeObstacle) {
            this.map = map;
        ...
        public void run() {
            ...
            Location relativeCoord = new Location(CoordUtils.fromAngle(relativeObstacle.theta(), distance));
