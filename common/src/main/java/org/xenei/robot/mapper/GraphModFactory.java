...
public class GraphModFactory {
        ...
        private static Resource RADIANS = ResourceFactory.createResource(Unit_URI.RADIAN_URL);
        ...
        static UpdateBuilder addPath(Resource model, Coordinate... points) {
            ...
            return new UpdateBuilder().addInsert(model, tn, RDF.type, Namespace.Path).addInsert(model, tn,
                    Geo.AS_WKT_PROP, path);
        }
